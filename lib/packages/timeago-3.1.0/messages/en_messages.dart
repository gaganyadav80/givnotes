...
class EnShortMessages implements LookupMessages {
  ...
  @override
  String lessThanOneMinute(int seconds) => '0s';  //now
  @override
  String aboutAMinute(int minutes) => '1m';
  @override
  String minutes(int minutes) => '${minutes}m';
  @override
  String aboutAnHour(int minutes) => '1h';  //~1h
  @override
  String hours(int hours) => '${hours}h';
  @override
  String aDay(int hours) => '1d';   //~1d
  @override
  String days(int days) => '${days}d';
  @override
  String aboutAMonth(int days) => '1mo';   //~1mo
  @override
  String months(int months) => '${months}mo';
  @override
  String aboutAYear(int year) => '1y';  //~1y
  @override
