...
//   /// The radius of the checkbox circle.
//   final double radius;

//   /// The width of stroke of checkbox widget
...
// // double _kEdgeSize = 18.0;
// // double _kCircleRadius = 11.0;
// const double _kStrokeWidth = 2.5;
// const double _kBorderStrokeWidth = 3.0;
...
//     assert(t >= 0.0 && t <= 0.5);
//     paint
//       ..strokeWidth = _kBorderStrokeWidth
//       ..style = PaintingStyle.stroke;
...
//     Offset start = Offset(kEdgeSize * 0.15, kEdgeSize * 0.45);
...
//       if (t <= 0.5) {
//         _drawCircleBorder(canvas, center, kCircleRadius, t, paint);
//       } else {
//         canvas.drawCircle(center, kCircleRadius + 2.0, paint);
...
//       canvas.drawCircle(center, kCircleRadius + 1, paint);
